...
export PATH=/home/benji/.meteor:$PATH
export PATH=/home/benji/.local/bin:$PATH

# bun completions
[ -s "/home/benji/.bun/_bun" ] && source "/home/benji/.bun/_bun"
...
# pnpm
export PNPM_HOME="/home/benji/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
# flutter
export FLUTTER_HOME=/home/benji/.local/share/flutter
...
# android studio
export ANDROID_STUDIO_HOME=/home/benji/.local/share/android-studio
...
export ANDROID_HOME=/home/benji/Android/Sdk
export PATH=$PATH:$ANDROID_HOME/platform-tools
export PATH=$PATH:$ANDROID_HOME/tools/bin

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/benji/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/benji/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/benji/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/benji/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
