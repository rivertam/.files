...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("javaScriptBraces", s:comment, "", "")
	call <SID>X("jsBraces", s:comment, "", "")
	call <SID>X("javaScriptFunction", s:purple, "", "")
	call <SID>X("jsFunction", s:purple, "", "")
  call <SID>X("javascriptMethodName", s:purple, "", "")
  call <SID>X("javascriptMethodAccessor", s:blue, "", "")
	call <SID>X("javaScriptConditional", s:green, "", "")
	call <SID>X("javaScriptConditionalElse", s:green, "", "")
	call <SID>X("jsConditional", s:green, "", "")
	call <SID>X("javascriptImport", s:green, "", "italic")
	call <SID>X("javascriptSwitch", s:green, "", "underline")
	call <SID>X("javascriptCase", s:green, "", "")
  call <SID>X("javascriptOpSymbol", s:comment, "", "")
  call <SID>X("javascriptOpSymbols", s:comment, "", "")
  call <SID>X("javascriptEndColons", s:comment, "", "")
  call <SID>X("javascriptOperator", s:green, "", "")
	call <SID>X("javaScriptRepeat", s:purple, "", "")
  call <SID>X("javascriptTemplateSB", s:purple, "", "")
	...
	call <SID>X("jsGlobal", s:blue, "", "")
  call <SID>X("jsGlobalObjects", s:blue, "", "")
	call <SID>X("javascriptStatement", s:red, "", "")
  call <SID>X("javascriptExport", s:red, "", "")
	call <SID>X("jsStatement", s:red, "", "")
  call <SID>X("jsThis", s:purple, "", "")
  call <SID>X("jsReturn", s:purple, "", "")
  call <SID>X("javascriptString", s:orange, "", "")
  call <SID>X("javascriptObjectLabel", s:orange, "", "")
  call <SID>X("javascriptReturn", s:purple, "", "")
  call <SID>X("javascriptVariable", s:aqua, "", "")
